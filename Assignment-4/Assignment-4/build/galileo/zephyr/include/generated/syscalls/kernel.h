...
K_SYSCALL_DECLARE3_VOID(K_SYSCALL_K_STACK_INIT, k_stack_init, struct k_stack *, stack, u32_t *, buffer, unsigned int, num_entries);
...
K_SYSCALL_DECLARE4_VOID(K_SYSCALL_K_MSGQ_INIT, k_msgq_init, struct k_msgq *, q, char *, buffer, size_t, msg_size, u32_t, max_msgs);
...
K_SYSCALL_DECLARE3_VOID(K_SYSCALL_K_PIPE_INIT, k_pipe_init, struct k_pipe *, pipe, unsigned char *, buffer, size_t, size);
